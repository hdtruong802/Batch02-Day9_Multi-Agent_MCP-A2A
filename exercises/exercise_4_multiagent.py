...
def law_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia pháp lý. Phân tích câu hỏi sau (tối đa 200 từ):
...
Tập trung: IRS, tax evasion, penalties, FBAR, FATCA. Trả lời tối đa 150 từ."""
...
Tập trung: SEC, SOX, FCPA, AML, regulatory violations. Trả lời tối đa 150 từ."""
...
Tập trung: GDPR, data protection, privacy rights, data breach, CCPA. Trả lời tối đa 150 từ."""
